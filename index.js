...
async function run() {
  try {
    ...
    // 2.for every menuIds (whice is an array), go find the item from menu collection
    // 3. for every item in the menu collection that you found from a   entry document
...
app.listen(port, ()=>{
    console.log(`bistro boss is sitting on post ${port}`);
})
